...
Debugger](http://msdn.microsoft.com/en-us/library/vstudio/3s68z0b3.aspx).
...
objects in the debugger using the Natvis framework](https://docs.microsoft.com/en-us/visualstudio/debugger/create-custom-views-of-native-objects)
...
post](http://www.os2museum.com/wp/?p=960) or [this social.msdn
thread](http://social.msdn.microsoft.com/Forums/vstudio/en-US/392ca62c-e502-42d9-adbc-b4e22d5da0c3/jit-debugging-32bit-app-crashing-with-access-violation).
...
discuss it with [#developers](https://chat.mozilla.org/#/room/#developers:mozilla.org) and
then post it here.
