...
you may be interested in the [Windows images provided by Microsoft](https://developer.microsoft.com/en-us/windows/downloads/virtual-machines/).
...
an official Windows 11 ISO file from [Microsoft's Download Windows 11 page](https://www.microsoft.com/en-us/software-download/windows11#SoftwareDownload_Edition).
...
Setup a [Dev Drive](https://learn.microsoft.com/en-us/windows/dev-drive/#how-to-set-up-a-dev-drive).
...
learn more about it [here](https://wiki.mozilla.org/MozillaBuild).
:::
...
:::{note}
When running `bootstrap.py` there will be a [UAC (User Account Control) prompt](https://docs.microsoft.com/en-us/windows/security/identity-protection/user-account-control/how-user-account-control-works) for PowerShell after
...
Microsoft Defender Antivirus manually](https://support.microsoft.com/en-ca/help/4028485/windows-10-add-an-exclusion-to-windows-security).
...
: 1. Copy the entire build error to your clipboard
  2. Paste this error on [gist.github.com](https://gist.github.com/) in the text area
...
they may be resolved by [upgrading your MozillaBuild](https://wiki.mozilla.org/MozillaBuild).
...
[turning Windows long paths on](https://learn.microsoft.com/en-us/windows/win32/fileio/maximum-file-path-limitation?tabs=registry).
