...
add_task(async function test_remote_policy_overrides_local_policy() {
  ...
  await EnterprisePolicyTesting.applyRemotePolicies(remotePolicies);
...
add_task(async function test_remote_and_local_policy_merged() {
  ...
  Assert.deepEqual(
    Services.policies.getActivePolicies(),
    { simple_policy0: POLICY_PARAM_STATE.APPLIED_LOCAL_POLICY, simple_policy1: POLICY_PARAM_STATE.APPLIED_REMOTE_POLICY },
