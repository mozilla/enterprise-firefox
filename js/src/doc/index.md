...
[[SMDOC]]. Information about the team, our processes, and about embedding
...
C++ type of [gc::Cell]. Each round of garbage collection will free up any
...
Values are represented with the [JS::Value] type which may in turn point to
an object that extends from the [JSObject] type. Objects include both plain
...
[Abstract Syntax Tree] (AST) temporarily and then run the *BytecodeEmitter*
(BCE) to generate [Bytecode] and associated metadata. We refer to this
resulting format as [Stencil] and it has the helpful characteristic that it
...
time (if the data is similar enough). See the [[SMDOC] JIT Inline Caches]
...
[Intermediate Representation] (Ion MIR) representation. This graph is
...
See [MIR Optimizations] for an overview of MIR optimizations.
...
[[smdoc]]: https://searchfox.org/mozilla-central/search?q=[SMDOC]&path=js%2F
[[smdoc] bytecode definitions]: https://searchfox.org/mozilla-central/search?q=[SMDOC]+Bytecode+Definitions&path=js%2F
[[smdoc] jit inline caches]: https://searchfox.org/mozilla-central/search?q=[SMDOC]+JIT+Inline+Caches
[[smdoc] shapes]: https://searchfox.org/mozilla-central/search?q=[SMDOC]+Shapes
[abstract syntax tree]: https://en.wikipedia.org/wiki/Abstract_syntax_tree
[bytecode]: https://en.wikipedia.org/wiki/Bytecode
[gc::cell]: https://searchfox.org/mozilla-central/search?q=[SMDOC]+GC+Cell
[intermediate representation]: https://en.wikipedia.org/wiki/Intermediate_representation
[js::value]: https://searchfox.org/mozilla-central/search?q=[SMDOC]+JS%3A%3AValue+type&path=js%2F
[jsobject]: https://searchfox.org/mozilla-central/search?q=[SMDOC]+JSObject+layout
[mir optimizations]: ./MIR-optimizations/index.html
[stencil]: https://searchfox.org/mozilla-central/search?q=[SMDOC]+Script+Stencil
